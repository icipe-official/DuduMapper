...
export default function OccurrenceFilter({
  ...
  cordinateArrayFromParent,
  clearSelectedAreaShape,
}: {
  open: boolean;
  ...
  cordinateArrayFromParent: any;
  clearSelectedAreaShape: any
}) {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ color: "green", fontSize: 15, mt: 4 }}>
                Select by Area
              </Typography>
              <Grid
                container
            ...
            <div className="button-container-style">
              {cordinateArrayFromParent.length > 0 && (
                <Button
                  sx={{
                  ...
                  onClick={clearSelectedAreaShape}
                >

...
import { fetchReference, fetchSiteInfo } from "@/app/api/occurrence";
import "../map/accordion-style.css";
import { CSSProperties } from "react";
import { useQuery } from "@tanstack/react-query";
import { fetchBionomics } from "@/app/api/occurrence";
  ...
  return (
    <div
      ...
      style={{
        ...scrollableStyle,
        ...borderStyle,
        ...{ width: "30%", overflowY: "auto", transitionDuration: "4s" },
      }}
    >
      ...
      >
        ...
        >
          <span style={{ flexWrap: "nowrap", display: "flex" }}>
            ...
            >
              <h4>Vector occurrence information</h4>
            </Box>
          </span>
        </AccordionSummary>
      ...
      >
        ...
        >
          <span style={{ flexWrap: "nowrap", display: "flex" }}>
            ...
            >
              <h4>Vector behavioral information</h4>
            </Box>
          </span>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        ...
        >
          <span style={{ flexWrap: "nowrap", display: "flex" }}>
            ...
            >
              <h4>Insecticide Resistance data</h4>
            </Box>
          </span>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        ...
        >
          <span style={{ flexWrap: "nowrap", display: "flex" }}>
            ...
            >
              <h4>Specimen collection site and environment data</h4>
            </Box>
          </span>
        </AccordionSummary>
        <AccordionDetails>
